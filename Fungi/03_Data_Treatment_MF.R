...
dir.create("./Output_Files_Seq_2_Methode_Fungi/Files/Stats_Files")


# 2. Load the data --------------------------------------------------------

count_tab <- read.table("./Output_Files_Seq_2_Methode_Fungi/Files/Output_Files/Seq2_MF_ASVs_counts.tsv", header=T, row.names=1, check.names=F, sep="\t")
tax_tab <- as.data.frame(read.table("./Output_Files_Seq_2_Methode_Fungi/Files/Output_Files/Seq2_MF_ASV_taxonomy.tsv", header=T, row.names=1, check.names=F, sep="\t"))
ASV_tab <- as.data.frame(read.table("./Output_Files_Seq_2_Methode_Fungi/Files/Output_Files/Seq2_MF_ASVs.fa", header=F, check.names=F, sep="\t"))
seqtab <- as.data.frame(read.table("./Output_Files_Seq_2_Methode_Fungi/Files/Output_Files/Seq2_MF_seqtab.nochim.tsv", header=T, row.names = 1, check.names=F, sep="\t"))
...
#want to be able to filter at 0.00005% and remove any chlorophyll or 
...
samples.out <- data.frame(name = rownames(count_tab))
...
df <- data.frame(cbind("name" = samples.out , "B" = df_rep))
...
title <- data.frame(name = rep(df$name,times=df$B))
...
write.table(tax_tab_clean, file="./Output_Files_Seq_2_Methode_Fungi/Files/Stats_Files/Seq2_MF_Tax_Tab.tsv", sep="\t", quote=F, col.names=NA)
...
write.table(Count_tab_clean, file="./Output_Files_Seq_2_Methode_Fungi/Files/Stats_Files/Seq2_MF_Count_Tab.tsv", sep="\t", quote=F, col.names=NA)
...
write.table(ASV_tab_final, file="./Output_Files_Seq_2_Methode_Fungi/Files/Stats_Files/Seq2_MF_ASV_Tab.tsv", sep="\t", quote=F, row.names = F, col.names=F)
write.table(ASV_tab_final, file="./Output_Files_Seq_2_Methode_Fungi/Files/Stats_Files/Seq2_MF_ASV_Tab.fa", sep="\t", quote=F, row.names = F, col.names=F)

seq_tab_clean <- seq_tab_filter[seqtab2$name %in% filter2, ]
### Remove the column used to filter (the on named "name") and save:
seq_tab_final <- subset(seq_tab_clean, select = -name)
write.table(seq_tab_final, file="./Output_Files_Seq_2_Methode_Fungi/Files/Stats_Files/Seq2_MF_seqtab.tsv", sep="\t", quote=F, row.names = T, col.names=NA)
write.table(seq_tab_clean, file="./Output_Files_Seq_2_Methode_Fungi/Files/Stats_Files/Seq2_MF_seqtab_name.tsv", sep="\t", quote=F, row.names = T, col.names=NA)
...
tract <- c("3_tracts", "4_tracts", "3_tracts","4_tracts","2_tracts","2_tracts","2_tracts","2_tracts","2_tracts","4_tracts","2_tracts","2_tracts", "3_tracts", "4_tracts","4_tracts","Control","Control", "Gallery","Gallery","Gallery","Gallery","Gallery","Gallery","Gallery","Gallery","Gallery","Gallery","Gallery")
tree <- c("Tree_1","Tree_1", "Tree_2", "Tree_2", "Tree_3","Tree_5","Tree_6","Tree_7","Tree_8","Tree_8","Tree_9","Tree_11","Tree_11","Tree_11","Tree_12", "Control", "Control", "Tree_1", "Tree_2","Tree_3","Tree_4","Tree_5","Tree_6","Tree_7","Tree_8","Tree_9","Tree_11","Tree_12")
status <- c("Tract", "Tract", "Tract","Tract","Tract","Tract","Tract","Tract","Tract","Tract","Tract","Tract", "Tract", "Tract","Tract", "Control", "Control", "Gallery","Gallery","Gallery","Gallery","Gallery","Gallery","Gallery","Gallery","Gallery","Gallery","Gallery")
bloc <- c("B2", "B2", "B2","B2","B2","B2","B2","B6","B6","B6","B6","B6", "B6", "B6","B6", "Control", "Control", "B2","B2","B2","B2","B2","B2","B6","B6","B6","B6","B6")
sample_info <- data.frame(Subject=subject, Tract=tract, Tree=tree, Status=status, Bloc=bloc)
head(sample_info)
write.table(sample_info, file="./Output_Files_Seq_2_Methode_Fungi/Files/Stats_Files/Seq2_MF_Sample_info.tsv", sep="\t", quote=F, col.names=NA)
...
### Save the file:
write.table(final_table_tot, file = "./Output_Files_Seq_2_Methode_Fungi/Files/Stats_Files/Seq2_MF_Final_Table.tsv", sep="\t", quote=F, col.names = FALSE)
