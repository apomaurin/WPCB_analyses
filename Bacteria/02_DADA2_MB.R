...
setwd("C:/Users/Léo-Paul/Desktop/Apo/Seq_2/Resultats_Seq_2/Methode_Bacteria")
...
path <- "C:/Users/Léo-Paul/Desktop/Apo/Seq_2/Resultats_Seq_2/Methode_Bacteria/Data/Raw/cutadapt"
list.files(path)
...
sample.names <- unname(sapply(cutFs.name, get.sample.name), sapply(cutRs.name, get.sample.name))
head(sample.names)
...
path <- "C:/Users/L?o-Paul/Desktop/Apo/Seq_2/Resultats_Seq_2/Methode_Bacteria/Data/Clean"

filtFs <- file.path(path, "Methode_Bacteria_filtered", paste0(sample.names, "_F_filt.fastq.gz"))
filtRs <- file.path(path, "Methode_Bacteria_filtered", paste0(sample.names, "_R_filt.fastq.gz"))
names(filtFs) <- sample.names
names(filtRs) <- sample.names

# Define the filtering parameters and filter ---- 

out <- filterAndTrim(cutFs, filtFs, cutRs, filtRs, truncLen=c(230,225),
...
path <- "C:/Users/Léo-Paul/Desktop/Apo/Seq_2/Resultats_Seq_2/Methode_Bacteria/Data/Clean/Methode_Bacteria_filtered"
list.files(path)
# Get all the zipped files
zipF <- list.files(path = "C:/Users/Léo-Paul/Desktop/Apo/Seq_2/Resultats_Seq_2/Methode_Bacteria/Data/Clean/Methode_Bacteria_filtered", 
...
# Merging of the foward and reverse reads together to obtain a full denoised sequences 
#--> Merging is performed by aligning the denoised F and R reads and construct 
#a merged "contig" sequences 
# Merge only if at least 12 bases overlap and are identical to each other in 
...
# Each data.frame contains : $sequence, $abundance, indices of the $foward and 
...
dim(seqtab.nochim)
write.table(seqtab.nochim, file="C:/Users/Léo-Paul/Desktop/Apo/Seq_2/Resultats_Seq_2/Methode_Bacteria/Output_Files_Seq_2_Methode_Bacteria/Files/Output_Files/Seq2_MB_seqtab.nochim.tsv", sep="\t", quote=F, 
            col.names=NA)
...
write.table(track, file="C:/Users/Léo-Paul/Desktop/Apo/Seq_2/Resultats_Seq_2/Methode_Bacteria/Output_Files_Seq_2_Methode_Bacteria/Files/Output_Files/Seq2_MB_Summary.txt")
...
path <- "./Data/Clean/Methode_Bacteria_filtered"
list.files(path)

#- Taxon: 
taxa <- assignTaxonomy(seqtab.nochim, "C:/Users/Léo-Paul/Desktop/Apo/Taxonomic_Assignation/silva_nr99_v138.1_train_set.fa",
                       multithread=FALSE)

#- Species
taxa <- addSpecies(taxa, "C:/Users/Léo-Paul/Desktop/Apo/Taxonomic_Assignation/silva_species_assignment_v138.1.fa",
                   allowMultiple = TRUE)

write.table(taxa, file="C:/Users/Léo-Paul/Desktop/Apo/Seq_2/Resultats_Seq_2/Methode_Bacteria/Output_Files_Seq_2_Methode_Bacteria/Files/Output_Files/Seq2_MB_Taxa_solo.tsv",
...
write.table(asv_fasta, file="C:/Users/Léo-Paul/Desktop/Apo/Seq_2/Resultats_Seq_2/Methode_Bacteria/Output_Files_Seq_2_Methode_Bacteria/Files/Output_Files/Seq2_MB_ASVs.fa", sep="\t", quote=F, col.names=NA) #Change the name !
...
write.table(asv_tab, "C:/Users/Léo-Paul/Desktop/Apo/Seq_2/Resultats_Seq_2/Methode_Bacteria/Output_Files_Seq_2_Methode_Bacteria/Files/Output_Files/Seq2_MB_ASVs_counts.tsv",
            sep="\t", quote=F, col.names=NA)#Change the name !
...
write.table(asv_tax, file="C:/Users/Léo-Paul/Desktop/Apo/Seq_2/Resultats_Seq_2/Methode_Bacteria/Output_Files_Seq_2_Methode_Bacteria/Files/Output_Files/Seq2_MB_ASV_taxonomy.tsv",
            sep="\t", quote=F, col.names=NA)#Change the name !
...
write.table(ASV.sample.sort, file="C:/Users/Léo-Paul/Desktop/Apo/Seq_2/Resultats_Seq_2/Methode_Bacteria/Output_Files_Seq_2_Methode_Bacteria/Files/Output_Files/Seq2_MB_ASV_samples.tsv", 
            sep="\t", quote=F, col.names=NA) #Change the name !
