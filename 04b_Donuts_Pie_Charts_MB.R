###
#Title : "Donuts_Pie_Charts_Bacteria"
...
donuts_plots <-
  ...
  scale_fill_manual(name=NULL,
                    breaks=c("*Bacteroidota*", "*Actinobacteriota*",
                             "*Proteobacteria*", "Relative abundance < 3%"),
                    values = c(brewer.pal(10, "RdBu"), "gray")) +
  coord_polar(theta = "y") +
...
### Save
ggsave("C:/Users/apoll/OneDrive/Documents/Thèse/14_Articles/1_Methode/Figures/1_Microbiome_Composition/Donuts_Pie_Charts_Phylum_Bacteria.jpeg", plot = donuts_plots, width = 12, height = 6, units = "in", dpi = 300)
ggsave("C:/Users/apoll/OneDrive/Documents/Thèse/14_Articles/1_Methode/Figures/1_Microbiome_Composition/Donuts_Pie_Charts__Phylum_Bacteria.pdf", plot = donuts_plots, width = 12, height = 6, units = "in", dpi = 300)
...
#Family:
##scale_fill_manual(name=NULL,
#                  breaks=c("*Anaplasmatacea*", "*Sphingomonadaceae*",
#                           "*Pseudomonadaceae*", "*Xanthomonadaceae*",
#                           "*Rhizobiaceae*", "*Fokiniaceae*",
#                           "*Microbacteriaceae*", "*Comamonadaceae*",
#                           "*Xanthobacteraceae*", "*Morganellaceae*", 
...
stats_by_status <- taxon_rel_abund %>%
  group_by(Status) %>%
  summarise(
    total_asvs = n(),
...
write.table(core_table, "./Output_Files_Seq_2_Methode_Bacteria/Files/Stats_Files/Microbiome_Composition/Seq2_MB_core_microbiome_Phylum.tsv", sep="\t", quote=F, col.names=NA)
...
# Save
ggsave("C:/Users/apoll/OneDrive/Documents/Thèse/14_Articles/1_Methode/Figures/1_Microbiome_Composition/Venn_Diagram_Family_Bacteria.jpeg", plot = venn_diagram, width = 12, height = 6, units = "in", dpi = 300)
ggsave("C:/Users/apoll/OneDrive/Documents/Thèse/14_Articles/1_Methode/Figures/1_Microbiome_Composition/Venn_Diagram_Family_Bacteria.pdf", plot = venn_diagram, width = 12, height = 6, units = "in", dpi = 300)
